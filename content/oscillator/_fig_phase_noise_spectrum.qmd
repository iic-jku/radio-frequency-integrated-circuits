...
# Add all noise sources as powers in the linear domain (uncorrelated noise sources)
...
#   1e4  = flicker corner, where the -30 dB/dec and -20 dB/dec asymptotes cross
#   1e7  = noise-floor onset, where the -20 dB/dec asymptote hits the -160 dBc/Hz floor
ax.axvline(1e4, color='gray', linestyle=':', alpha=0.7, linewidth=1)
ax.axvline(1e7, color='gray', linestyle=':', alpha=0.7, linewidth=1)
