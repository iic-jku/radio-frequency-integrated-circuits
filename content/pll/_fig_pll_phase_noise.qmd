...
# For simplicity the reference is modelled as a flat -140 dBc/Hz floor over the
# whole plotted offset range; a real crystal would show 1/f^3 and 1/f^2 regions too.
L_ref_flat = -140  # Reference phase noise in dBc/Hz
L_ref_unfiltered = L_ref_flat + 20*np.log10(N)  # Scaled by N² (20*log10(N))
