...
#| echo: false
#| fig-cap: "Two-tone IM3 test showing fundamental and IM3 product power vs. input power, with IIP3 intercept point definition. Equal input power per tone is assumed."
...
ax.axvline(IP3_in_dBm, color='gray', linestyle=':', alpha=0.7, 
           label=f'IIP3 = {IP3_in_dBm:.1f} dBm')
