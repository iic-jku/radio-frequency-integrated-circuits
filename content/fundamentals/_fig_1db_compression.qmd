...
#| echo: false
#| fig-cap: "1-dB compression point test showing input vs. output power relationship and the definition of P1dB."
...
ax.plot(P1dB_in, P1dB_out, 'ko', markersize=8, markerfacecolor='black', 
        markeredgewidth=2, markeredgecolor='black', label=f'P1dB (input) = {P1dB_in:.1f} dBm')
