...
| Modulation | Bits/Symbol | Required $E_\mathrm{s}/N_0$ (dB) |
|------------|--------------|--------------------|
| BPSK       | 1            | 9.6                |
| QPSK       | 2            | 12.6               |
| 16-QAM     | 4            | 18.2               |
...
| 1024-QAM   | 10           | 36.9               |
| 4096-QAM   | 12           | 43.2               |
: Required symbol-energy-to-noise ratio $E_\mathrm{s}/N_0$ for different modulation schemes to achieve BER = $10^{-5}$ in an AWGN channel w/o error correction {#tbl-modulation-snr}
