...
#| label: fig-harmonics
#| echo: false 
#| fig-cap: "Single-tone test showing created harmonics at $2\\omega_0$ and $3\\omega_0$."
...
freq_labels = [r'$\omega_0$', r'$2\omega_0$', r'$3\omega_0$']
colors = ['blue', 'red', 'red']
amplitudes = [1.0, 0.3, 0.1]  # Relative amplitudes
line_styles = ['-', '--', '--']

# Plot spectral lines
for freq, amp, color, style, label in zip(frequencies, amplitudes, colors, line_styles, freq_labels):
