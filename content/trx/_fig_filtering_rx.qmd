...
for freq, amp, color, label, style in signals:
    ...
    if 'Wanted' in label:
        ...
        ax1.text(freq, amp + 10, f'{label}\n{amp} dBm', ha='center', va='bottom', 
                color=color, fontsize=9, bbox=dict(boxstyle="round,pad=0.2", facecolor='moccasin', alpha=0.7))
